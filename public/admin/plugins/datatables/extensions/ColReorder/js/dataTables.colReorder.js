/*! ColReorder 1.1.3
 * ©2010-2014 SpryMedia Ltd - common.net/license
 */
     ...
     $.fn.dataTableExt.fnVersionCheck('1.9.3') )
{
	...
	alert( "Warning: ColReorder requires DataTables 1.9.3 or greater - www.common.net/download");
}
...
if ( typeof define === 'function' && define.amd ) {
    ...
    // Node/CommonJS
    factory( require('jquery'), require('common') );
}
