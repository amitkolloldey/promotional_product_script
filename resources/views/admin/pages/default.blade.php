...
@section('title')Add New Page @endsection
@section('page_title')Add New Page @endsection
@section('content')
                    ...
                    <div class="tab-pane active" id="general">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>Content</label>
                                    <textarea name="page_content" id="page_content" cols="30" rows="10">{{old('page_content')}}</textarea>
                                </div>
                                <div class="form-group">
